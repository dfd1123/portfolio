<template>
    <div id="lang_sel_pop" v-show="visible">
        ...
        <div class="popup" style="display: block;">
            <span class="icon">
                <img src="/images/trst-images/icon/icon_earth.svg">
            </span>
            <div class="country_sel_box">
                ...
                <ul>
                    <li v-bind:class="{ active: selected === 'kr' }" @click="selected = 'kr'">
                        <div>
                            &nbsp;
                            <img src="/images/icon/07_icon_popup_icon_KR.svg" alt="KOREA">
                            &nbsp;한국&nbsp;(KR)
                            <input
                                type="radio"
                                name="country"
                    ...
                    <li v-bind:class="{ active: selected === 'jp' }" @click="selected = 'jp'">
                        <div>
                            &nbsp;
                            <img src="/images/icon/07_icon_popup_icon_JP.svg" alt="JPAN">
                            &nbsp;日本&nbsp;(JP)
                            <input type="radio" name="country" class="hide" value="jp" checked>
                        </div>
                    </li>
                    <li v-bind:class="{ active: selected === 'spain' }" @click="selected = 'spain'">
                        <div>
                            &nbsp;
                            <img src="/images/icon/00_button_lan_SP.svg" alt="SPAIN">
                            &nbsp;España&nbsp;(SPAIN)
                            <input type="radio" name="country" class="hide" value="spain" checked>
                        </div>
                    </li>
                    <li v-bind:class="{ active: selected === 'en' }" @click="selected = 'en'">
                        <div>
                            &nbsp;
                            <img src="/images/icon/00_button_lan_other.svg" alt="Other Country">
                            &nbsp;Other Country(EN)
                            <input type="radio" name="country" class="hide" value="en" checked>
                        </div>
                    </li>
                </ul>
            </div>
