                ...
                <ul>
                    ...
                    <li data-symbol="wallet" class>
                        <button @click="$router.replace('/wallet_add')">
                            <img src="/images/old-images/icon_wallet add.svg" alt="add_wallet" />
                        ...
                        <div class="coin_hd_bt">
                            <ul>
                                <li class="sendPage_btn" @click="$router.replace('/wallet_send')">
                                    <img src="/images/old-images/home_button_send2.svg" alt />
                                    {{__('home.send')}}
                                </li>
                                <li
                                    class="getsPage_btn"
                                ...
                                >
                                    <img src="/images/old-images/home_button_get2.svg" alt />
                                    {{__('home.receive')}}
                                </li>
                                <li
                                    class="buyPage_btn"
                                ...
                                >
                                    <img src="/images/old-images/home_button_buy2.svg" alt />
                                    {{__('home.buy')}}
                                </li>
                                <li
                                    class="sellPage_btn"
                                ...
                                >
                                    <img src="/images/old-images/home_button_sell2.svg" alt />
                                    {{__('home.sell')}}
                                </li>
                            </ul>
                        </div>
                            ...
                            >
                                ...
                                >
                                    <td v-if="history.sign === '+' && history.status === 'receive'">
                                        <img src="/images/old-images/icon_get.svg" alt="get" />
                                        <!---->
                                    ...
                                    >
                                        <img src="/images/old-images/icon_send.svg" alt="send" />
                                        <!---->
                                    ...
                                    >
                                        <img src="/images/old-images/icon_buy.svg" alt="buy" />
                                        <!---->
                                    ...
                                    >
                                        <img src="/images/old-images/icon_sell.svg" alt="sell" />
                                        <!---->
                            ...
                            <tbody v-else id="history_tbody">
                                <tr>
                                    <td colspan="3" class="non_data">
                                        <img src="/images/old-images/icon_sad.svg" alt="sad_icon" />
                                        <br />
                                        {{__('home.no_history')}}
                                    </td>
                                </tr>
...
.myinfor_btn button:first-child {
    background-image: url(/images/old-images/home_button_my_info.svg);
    background-size: 35px;
    background-position: 10px 7px;
}

.myinfor_btn button:last-child {
    background-image: url(/images/old-images/home_button_my_property.svg);
    background-size: 35px;
    background-position: 10px 7px;
}
