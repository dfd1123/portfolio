...
class PushController extends Controller
{
    ...
    private function send_notification($tokens, $data)
    {
        ...
        // 헤더에 푸시 키 추가
        $headers = array(
            'Authorization:key =AAAA9zozlU0:APA91bG8lWLguzI5uW64DAsqKyg5x6mbLbXLORu3Hxm58JZVNYtnrsxDcepEdoFOa9sr7UYzhuKy1UgiCKclQ2nalyWfHyR1ylHCFwi-ybqQAPVizME7VpzJ-Qjtzv7pWcZznLNVS0qG',
