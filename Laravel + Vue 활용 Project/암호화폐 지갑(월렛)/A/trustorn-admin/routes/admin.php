...
Route::group(['as' => 'admin.'], function() {
	...
	Route::post('/ico_qna_store', 'AdminController@ico_qna_store') -> name('ico_qna_store');

	Route::get('/ico_main_data', 'AdminController@ico_main_data') -> name('ico_main_data');
	...
	Route::group(['middleware' => 'admin'], function() {
		...
		Route::get('/company_info', 'AdminController@company_info') -> name('company_info');

		Route::post('/company_info_update', 'AdminController@company_info_update') -> name('company_info_update');

		/* 수익률 관련 */

		Route::get('/monthly_revenue_edit', 'AdminController@monthly_revenue_edit') -> name('monthly_revenue_edit');

		Route::post('/monthly_revenue_update', 'AdminController@monthly_revenue_update') -> name('monthly_revenue_update');

		Route::get('/users_revenue_manage', 'AdminController@users_revenue_manage') -> name('users_revenue_manage');

		Route::get('/user_revenue_excel', 'AdminController@user_revenue_excel') -> name('user_revenue_excel');

		Route::get('/ico_edit', 'AdminController@ico_edit') -> name('ico_edit');

		Route::post('/ico_update', 'AdminController@ico_update') -> name('ico_update');

		Route::get('/ico_qna_list', 'AdminController@ico_qna_list') -> name('ico_qna_list');

		Route::get('/ico_qna_view/{id}', 'AdminController@ico_qna_view') -> name('ico_qna_view');
		...
		Route::post('/cash_confirm', 'AdminController@cash_confirm') -> name('cash_confirm');
