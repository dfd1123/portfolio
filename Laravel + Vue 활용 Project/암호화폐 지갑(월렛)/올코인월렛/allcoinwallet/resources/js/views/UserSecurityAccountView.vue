<template>
    <div class="ai_wrapper">
        <header-component
            ...
            rightButton="home"
        ></header-component>
        <div class="ai_container bgcolor account_box">
            <div class="top_box">
                <p class="hr_line">
                ...
                <p class="hr_line step">
                    <span>{{__('user_security_account.step2')}}</span>
                    <span>
                        <u>2</u>/2
                    </span>
                </p>
                <p class="gage per_50 right"></p>
                <ul class="gage_p">
                    <li>{{__('user_security_account.document1')}}</li>
                    <li class="now">{{__('user_security_account.document2')}}</li>
                </ul>
            </div>
            ...
            <div class="user_list step_area step4 scroll_area">
                <div class="sd_box bt_15px">
                    <div class="form_line">
                        ...
                        <div class="in_form_line account">
                            <label
                                class="form_title -placeholder_small_text"
                ...
                <div class="sd_box btn_sd_box atch">
                    ...
                    <div class="btn_footer" v-bind:class="{not_btn: isAllFilesNotUploaded}">
                        <div>{{__('user_security_account.pic_attach_ok')}}</div>
                    </div>
                </div>
...
.account_box .top_box .hr_line:first-child u {
    text-decoration: none;
    font-weight: 900;
}

.account_box .top_box .hr_line:first-child strong {
    color: #0072ff;
}
...
.account_box .top_box .hr_line.step {
    font-size: 20px;
    color: #0045ab;
    font-weight: 600;
    margin-bottom: 5%;
...
.account_box .top_box .hr_line.step span:nth-child(2) {
    position: absolute;
    right: 0;
    font-size: 13px;
    color: #5a5a5a;
...
.account_box .top_box .hr_line.step span:nth-child(2) u {
    color: #0072ff;
    text-decoration: none;
    font-size: 16px;
}

.account_box .top_box .gage {
    width: 100%;
    height: 2px;
...
.account_box .top_box .gage.per_50:after {
    width: 50%;
}

.account_box .top_box .gage:after {
    content: "";
    position: absolute;
    width: 20%;
    height: 10px;
...
.account_box .top_box .gage.left:after {
    left: 0;
}

.account_box .top_box .gage.right:after {
    right: 0;
}

.account_box .top_box .gage_p {
    width: 100%;
    margin-top: 10px;
    float: left;
    padding: 0;
...
.account_box .top_box .gage_p li.now {
    color: #5a5a5a;
}
...
.account_box .in_form_line.account {
    height: 30px;
    border-bottom: 1px solid #dcdcdc;
    position: relative;
}

.account_box .in_form_line input {
