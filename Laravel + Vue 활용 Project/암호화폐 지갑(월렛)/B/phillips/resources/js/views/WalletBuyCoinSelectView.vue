<template>
    <div class="ai_wrapper">
        <header-component
            leftButton="back"
            leftButtonRoute="/wallet_buy"
            center="text"
            :centerText="__('wallet_buy_coin_select.title')"
            rightButton="home"
        ></header-component>
        <div class="ai_container bgcolor">
            <div class="coin_name_sch">
                <input
                    ...
                    :placeholder="__('wallet_buy_coin_select.placeholder_search_name')"
                />
                <i class="far fa-search"></i>
            </div>
            <div class="s_text coin_s_text">{{__('wallet_buy_coin_select.select_coin')}}</div>
            <div class="name_line">
                <span>{{__('wallet_buy_coin_select.coin_name')}}</span>
                <span>{{__('wallet_buy_coin_select.own_coin')}}</span>
            </div>
        ...
        <footer-component
            :buttonText="__('wallet_buy_coin_select.select')"
    ...
    methods: {
        ...
        async selectButtonClick() {
            if (this.selected) {
                ...
                this.$router.replace("/wallet_buy");
            }
        }
    }
};
