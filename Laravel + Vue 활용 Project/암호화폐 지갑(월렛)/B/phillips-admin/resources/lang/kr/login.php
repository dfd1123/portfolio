...
'join_login_sentence3' => 'COINTOUSE거래소 서비스 이용약관 동의 (필수)',
'join_login_sentence4' => 'COINTOUSE 거래소 개인정보 수집 및 이용동의 (필수)',
'join_login_sentence5' => 'COINTOUSE 거래소 마케팅 수신에 동의합니다. (선택)',
'join_login_sentence5_mb' => 'COINTOUSE 거래소 마케팅 수신에 동의합니다. (선택)',
...
'join_login_sentence8' => '회원가입이 완료되었습니다.<br>이메일 인증 후 COINTOUSE의 모든 서비스를 이용할 수 있습니다.',
'join_login_sentence9' => '*마이페이지>보안강화에서 OTP인증을 완료하여 더욱 안전한 COINTOUSE를 사용해보세요.<br>OTP인증 완료시 입출금 한도가 상승됩니다.',
'login' => '로그인하기',
...
're' => '재전송',
'suc' => '전송완료',
'join_login_sentence14' => '서비스 이용을 위해서는 이메일 인증이 필요합니다.<br>이메일 인증 완료시, COINTOUSE를 이용하실 수 있습니다.',   
'checking' => '중복검사',
'change2' => '비밀번호 변경',
//거래소 서비스 이용약관
'agree_tit' => 'COINTOUSE 거래소 서비스 이용약관',
