...
function initOnReady() {
	var udf_datafeed = new Datafeeds.UDFCompatibleDatafeed(document.getElementsByName("setting_url")[0].value);

	var widget = window.tvWidget = new TradingView.widget({
		// debug: true, // uncomment this line to see Library errors and warnings in the console
		symbol: document.getElementsByName("chart_symbol")[0].value.toUpperCase(),
		autosize: true,
		width:600,
		interval: '60',
		toolbar_bg: '#f4f7f9',
