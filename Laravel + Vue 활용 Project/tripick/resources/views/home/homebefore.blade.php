...
<div class="wrapper wrapper--home">
    ...
    <div class="ani-logo-group">
        ...
        <div class="ani-logo-group__logo">
            ...
            <svg id="그룹_410" class="logo--text logo--text--015" data-name="그룹 410" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" width="52.252" height="72.119" viewBox="0 0 52.252 72.119">
                ...
                <circle id="타원_21" data-name="타원 21" cx="3.567" cy="3.567" r="3.567" transform="translate(22.38 24.178)"
                    fill="#00dbd8" />
                ...
                <circle id="타원_22" data-name="타원 22" cx="4.02" cy="4.02" r="4.02" transform="translate(21.814 23.386)"
                    fill="#00dbd8" />
                ...
                <path id="패스_2425" data-name="패스 2425" d="M151.665,292.216h0Z" transform="translate(-148.347 -253.261)"
            ...
            <svg class="logo--text logo--text--016" xmlns="http://www.w3.org/2000/svg" width="40.391" height="52.808"
            ...
            <svg class="logo--text logo--text--018" xmlns="http://www.w3.org/2000/svg" width="12.488" height="57.803"
            ...
            <svg class="logo--text logo--text--019" xmlns="http://www.w3.org/2000/svg" width="38.036" height="52.808"
            ...
            <svg class="logo--text logo--text--020" xmlns="http://www.w3.org/2000/svg" width="12.488" height="57.803"
                viewBox="0 0 12.488 57.803">
                <path id="패스_2697" data-name="패스 2697"
                    d="M643.24,186.321a6.466,6.466,0,0,1-4.5-1.606,5.652,5.652,0,0,1,0-8.242,6.558,6.558,0,0,1,4.5-1.57,6.429,6.429,0,0,1,4.46,1.57,5.732,5.732,0,0,1,0,8.242A6.339,6.339,0,0,1,643.24,186.321Zm-5.281,6.423h10.419v39.963H637.959Z"
                    transform="translate(-636.96 -174.903)" fill="#00244C" />
            </svg>
            <svg class="logo--text logo--text--021" xmlns="http://www.w3.org/2000/svg" width="32.541" height="41.961"
            ...
            <svg class="logo--text logo--text--022" xmlns="http://www.w3.org/2000/svg" width="37.037" height="56.947"
    ...
    <div class="wrapper--home__earth">
        <img src="/img/bg/bg-home-map01.svg" alt="map 01" class="wrapper--home__earth__img wrapper--home__earth__img01">
        <img src="/img/bg/bg-home-map02.svg" alt="map 02" class="wrapper--home__earth__img wrapper--home__earth__img02">
        <img src="/img/bg/bg-home-map03.svg" alt="map 03" class="wrapper--home__earth__img wrapper--home__earth__img03">
        <img src="/img/bg/bg-home-line.svg" alt="map 04" class="wrapper--home__earth__img wrapper--home__earth__img04">
    </div>

    <div class="wrapper--home__con">
        <p class="wrapper--home__con__p">나에게 가장 잘 맞는<br> 여행을 추천받으세요!</p>
        <button type="button" class="button button--01" onclick="{{ $user_id == '' ? 'alert_href();' : 'location.href="/estimate/step1";' }}">추천받기</button>
    </div>

    <div class="matching-product--bt-fixed">
        <span class="inline inline--center">
            <a href="#" onclick="{{ $user_id == '' ? 'alert_href();' : 'location.href="/pr_home";' }}" class="wrapper--home__product__alink wrapper--home__product__alink--view-prdt">추천 상품 보기</a>
            <a href="/find" class="wrapper--home__product__alink wrapper--home__product__alink--find-frnd">동행친구 찾기</a>
        </span>
        <ul id="matching_product_slick">
            @forelse($planners as $planner)
            <li class="matching-product__list">
                <div class="matching-product__card">
                    <figure class="matching-product__card__logo"
                        style="background-image: url(/storage/fdata/planner/thumb/{{ $planner->pln_thumb }});"></figure>
                    <dl class="matching-product__card__info">
                        <dt class="matching-product__card__title">{{ $planner->pln_name }}
                            <span class="matching-product__card__status is-ing">{{ $planner->pln_type == 0 ? '개인' : '업체' }}</span>
                        </dt>
                        <dd class="matching-product__card__desc01">{{ $planner->pln_desc }}</dd>
                    </dl>
                </div>
            </li>
            @empty
...
<script>
    ...
    function alert_href(){
        dialog.alert({
            title:'잠깐!',  
            message: '로그인이 필요한 서비스입니다<br> 로그인후 이용해 주세요',
            button: "확인",
    ...
    $(window).on('load',function(){
        $('#matching_product_slick').addClass('ani');
    })
