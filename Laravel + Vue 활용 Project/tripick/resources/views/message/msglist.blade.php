        ...
        $.ajax({
              ...
              if (res.state == 1) {
                    ...
                    for (var i = 0; i < res.query.length; i++) {
                        ...
                        var msgdetail = "/msg/view?eb_id=" + message.eb_id;
                        if(message.eb_id ==null){
                            msgdetail = "/msg/view?prd_id=" + message.prd_id;
                        }
                        ...
                        <figure class="user-list__thum user-message__thum is-active" style="background-image: url(/storage/fdata/planner/thumb/'+message.pln_thumb+');"></figure>\
                        ...
                        <p class="user-list__msg">' + msg_content+ '</p>';
