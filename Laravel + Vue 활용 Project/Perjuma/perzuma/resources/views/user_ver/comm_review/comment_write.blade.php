...
<template id="estimate_file_li">
    <div class="estimate_file_li">
        ...
        <span id="estimate_file_download"><img src="{{asset('/images/download_btn.svg')}}" alt="download_btn"></span>
    </div>
</template>
...
<script>
    ...
    $('.estimate_file_inp').on('change', function(){
        ...
        $.ajax({
            type : "POST",
            url : "/api/user_ver/comment", //"/api/estimate_file_store",
            data : dataFile,
            dataType: 'json',     
            mimeType: 'multipart/form-data',
            contentType: 'multipart/form-data',
