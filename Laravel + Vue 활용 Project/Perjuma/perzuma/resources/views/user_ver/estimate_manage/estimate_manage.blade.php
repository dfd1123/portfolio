...
<div class="estimate_manage_wrap">
    <div class="estimate_manage_content animated fadeInUp delay-04s">
        <div class="estimate_manage_box">
            ...
            <div>
                <a href="{{route('user_ver.result_confirm').'?id='.$trd_no.'&kind=re_confirm'}}" class="go_btn" anim="ripple">견적사항 관리</a>
            </div>
        </div>
    </div>
</div>
...
<template id="estimate_list_li">
        <div class="estimate_li"> 
            <div class="estimate_company_img">
                <img src="{{asset('/images/ex1.jpg')}}" id="company_img" alt="">
            </div>
            <div class="estimate_company_infor">
                <h3 id="company_name"></h3>
                <ul>
                    <li>시공 <span id="construction_cnt"></span>건</li>
                    <li>리뷰 <span id="review_cnt"></span>건</li>
        ...
        success : function(data) {
            data.estimate_lists.forEach(function(item, index, array) {
                ...
                if(trd_no ==''){
                    ...
                    templete.attr("onclick","location.href='/user_ver/company_page/estimate_view?agent_no="+item.agt_no+"&trd_no="+trd_no+"'");
                }
                console.log(data.trade.state);
                if(data.trade.agent_no == item.agt_no){
                    ...
                    if(data.hours == 0 && data.minute == 0){
                        ...
                        $('.request_daedline').css('display','block');
                    }
                }
