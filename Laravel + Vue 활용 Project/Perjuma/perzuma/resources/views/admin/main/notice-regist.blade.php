                    ...
                    <div class="col-lg-12">
                        <div class="card" style="padding-top:1em;">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="notice_title" type="text" placeholder="ex) 공지사항 제목입니다" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">내용</label>
                                    <div class="col-md-12">
                                        <textarea id="notice_content" rows="5" class="form-control form-control-line"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
