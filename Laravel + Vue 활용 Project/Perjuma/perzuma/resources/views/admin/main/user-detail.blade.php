...
<div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">사용자 상세 정보</h3>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img id="user_thumb" src="/adminassets/images/users/5.jpg" class="img-circle" width="150" alt="사용자 프로필 사진"/>
                                    <h4 id="name" class="card-title m-t-10">{{$query['query'][0]->name}}</h4>
                                </center>
                            </div>
                            <div>
                                <hr> </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <a style="float:right;" href="/admin/trades?search_no={{$query['query'][0]->user_no}}&search_type=1">거래 내역 페이지로 ></a>
