...
$(function(){
    $('#updatebtn').click(function(){
        ...
        $.ajax({
            ...
            dataType: "json",
            data : param,
            url : "/admin/supervison/normalinfo",
...
<div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">감리 상세 정보</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">메인</a></li>
                        <li class="breadcrumb-item">감리 관리</li>
                        <li class="breadcrumb-item active">감리 상세 정보</li>
                    </ol>
                </div>
            </div>
            <!-- ============================================================== -->
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            ...
                            <div>
                                ...
                                <small class="text-muted p-t-30 db">감리 상태</small>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#settings" role="tab">감리 정보 수정</a> </li>
                            </ul>
                            <!-- Tab panes -->
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <a style="float:right;" href="/admin/trades?search_no={{$query['query'][0]->sp_no}}&search_type=4">거래 내역 페이지로 ></a>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal form-material">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" id="sp_name" placeholder="Johnathan Doe" class="form-control form-control-line" value="{{$query['query'][0]->sp_name}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">전화번호</label>
                                                <div class="col-md-12">
                                                    <input type="text" id="sp_contact" placeholder="123 456 7890" class="form-control form-control-line" value="{{$query['query'][0]->sp_contact}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <button type ="button" id="updatebtn" class="btn btn-success">정보 업데이트</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
