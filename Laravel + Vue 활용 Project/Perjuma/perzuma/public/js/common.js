...
$.ajaxSetup({
  ...
  beforeSend: function beforeSend(xhr) {
    ...
    if (localStorage.passportToken) {
      xhr.setRequestHeader("Authorization", "Bearer ".concat(localStorage.passportToken));
    }
  },
    ...
    try {
      if (localStorage.passportToken) {
        $.ajax({
          ...
          error: function error(data) {
            var token = localStorage.passportToken;
            localStorage.passportToken = token;
            $.ajaxSetup({
              beforeSend: function beforeSend(xhr) {
                xhr.setRequestHeader("Authorization", "Bearer ".concat(token));
...
module.exports = __webpack_require__(/*! D:\perzuma\perzuma\resources\js\common.js */"./resources/js/common.js");
