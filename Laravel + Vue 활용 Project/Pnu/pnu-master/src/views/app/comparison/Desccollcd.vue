<template>
  <div>
    <b-row>
      <b-colxx xxs="12">
        <piaf-breadcrumb :heading="$t('menu.desccollcd')" />
    ...
    <b-row>
      <b-colxx xxs="6">
        <b-card class="mb-4" :title="$t('menu.desccollcd')">
      ...
      <b-colxx xxs="6" class="mb-4">
        <b-card>
          <b-row>
            <h3 class="mb-4" style="color:#0078FF; font-size: 1.5em;font-weight:bold;width:100%">Step 1 : 단과대학을 클릭하세요</h3>
          </b-row>
          <vuetable
            ref="vuetable"
            :load-on-start="false"
