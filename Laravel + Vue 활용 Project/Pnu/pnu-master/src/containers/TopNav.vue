  ...
  <nav class="navbar fixed-top">
    ...
    <div class="navbar-right">
      ...
      <div class="header-icons d-inline-block align-middle">
        <div v-if="false" class="position-relative d-none d-sm-inline-block">
          <b-dropdown
            variant="empty"
            size="sm"
            right
        ...
        <div v-if="false" class="position-relative d-inline-block">
          <b-dropdown
            variant="empty"
            size="sm"
            right
          ...
          <template slot="button-content">
            ...
            <span>
              <img
                ...
                :src="currentUser.img || '/master/assets/img/default-profile.png'"
              />
            </span>
          </template>
          <b-dropdown-item @click="changePassword">비밀번호 변경</b-dropdown-item>
          <b-dropdown-divider />
...
export default {
  ...
  methods: {
    ...
    logout () {
      this.signOut().then(() => {
        this.$router.push('/master/user/login')
      })
    },
    changePassword () {
      this.$router.push('/master/user/change-password')
    },
