...
class File_store {
    ...
    public function CK_Image_store($store_path, $images){
        $storage_path = "image/";
    ...
    public function Image_store_profile($store_path, $images){
        $storage_path = "image/";
    ...
    public function Image_update_profile($store_path, $images, $before_arr, $req_index){
        $storage_path = "image/";
        $delete_path = "image/";
