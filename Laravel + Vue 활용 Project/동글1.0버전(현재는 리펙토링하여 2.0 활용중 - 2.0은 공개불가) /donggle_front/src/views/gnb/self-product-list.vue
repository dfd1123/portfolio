  ...
  >
    <div class="dg-gnb-choice-group">
      <div class="dg-gnb-title-group">
        ...
        <GnbTitle
          gnb-title="국내자체제작"
          gnb-text="국내에서 자체적으로 제작한 상품을 소개드려요."
        />
        <!-- * 대메뉴 제목 E -->
        <ul class="in-breadcrumb type01">
          ...
          <li class="_list active">
            <a href="/product/list/self">국내자체제작</a>
          </li>
        </ul>
      </div>
    </div>
        ...
        <div class="l-contents-group">
          ...
          >
            <img
              ...
              class="in-empty-icon"
            >
            <span class="in-empty-ment">국내자체제작에 등록된 상품이 없습니다.</span>
          </div>
          <div
            class="loading_wrap"
...
<script>
  ...
  export default {
    ...
    methods: {
      async ItemLoad () {
        try {
          const res = (await this.$http.get(this.$APIURI + 'items/self_list', { params: this.form })).data
