<template>
  <div>
    ...
    >
      <h2>
        선호하는 스타일을 선택해주세요.<br>
        고객님의 스타일에 맞춰 상품을 추천해드립니다.
      </h2>
      <router-link
        :to="'/register/complete?id='+id+'&name='+name"
        class="skip_btn"
      >
        다음에 할게요
      </router-link>
      <div class="dg-reg-style_choice_box">
        <button
          type="button"
        ...
        >
          ...
          <button
            class="_close_btn"
            @click="OneCancel(uniqHashTag)"
          ></button>
        </div>
      </div>
      <div class="dg-reg-style_wrap clear_both">
        <StyleSelectItem
