                ...
                >
                  ...
                  <div class="_board_title_label">
                    ...
                    <span
                      ...
                      class="_check _end"
                    >답변완료</span>
                    <span class="_date">{{ qna.created_at }}</span>
                ...
                <li class="_cs_content _support_content _support_quastion_content">
                  <div class="_support_content_wrap clear_both">
                    <div class="_board_title_label _support_content_title">
                      <span class="_name">{{ this.$store.state.user.name }}</span>
  ...
  export default {
    ...
    methods: {
      ...
      async QnaDelete () {
        ...
        if (result) {
          try {
            const res = (await this.$http.delete(this.$APIURI + 'qna/' + this.showQna.id)).data
...
<style lang="scss" scoped>
  ._support_wrapper ._board_title_label {
    width: 100%;
  }
</style>
