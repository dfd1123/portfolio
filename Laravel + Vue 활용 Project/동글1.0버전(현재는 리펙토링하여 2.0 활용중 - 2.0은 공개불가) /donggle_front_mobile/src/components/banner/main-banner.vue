      ...
      >
        ...
        >
          <img
            ...
            :src="storageUrl+ConvertImage(mainBanner.bn_img_mobile)"
        ...
        <a
          v-else
          href="#"
          @click.prevent="NativePopup(mainBanner.bn_url)"
          style="display:block;float:left;"
        >
          <img
            class="main-banner-img"
  ...
  export default {
    ...
    methods: {
      ...
      handleDestroy (event, slick) {
        ...
        this.mainBanners = this.mainBanners[0]
      },
...
<style lang="scss" scoped>
  .dg-main-banner-area > .main-banner-slider > .main-banner-wrap {
    display: none !important;
  }

  .dg-main-banner-area > .main-banner-slider > .main-banner-wrap:first-child {
