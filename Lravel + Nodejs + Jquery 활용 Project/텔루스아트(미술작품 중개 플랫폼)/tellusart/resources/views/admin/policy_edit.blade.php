...
<form enctype="multipart/form-data" class="event_edit_adm_form" id="event_add_form" method="post" action="{{route('admin.policy_update')}}">
		        	...
		        	<tr>
		        		<td>
		        			<textarea class="body" name="mobile_contents">
		        				@if($policy->mobile_contents != NULL)
