	...
	<div class="card-body">
		<form method="post" action="{{route('admin.popup_update',$popup->id)}}" enctype="multipart/form-data">
				...
				<table class="table table-bordered cate_adm_table" width="100%" cellspacing="0">
					<tbody>
						...
						<tr>
							...
							<td>
								...
								@else
									<img src="" alt="" id="foo" />
								@endif
								<label for="mb_img" class="myButton use">업로드</label>	
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="link" class="form-control tsa-input-st" value="{{$popup->link}}" required="required"/>
							</td>
						</tr>
					</tbody>
				</table>
			...
			<div class="mint_btn_group">
				...
				<button type="button" class="btn btn-default mint_btn" onclick="location.href='{{route('admin.popup_delete', ['id' => $popup->id])}}'">
				삭제
				</button>
			</div>
		</form>
