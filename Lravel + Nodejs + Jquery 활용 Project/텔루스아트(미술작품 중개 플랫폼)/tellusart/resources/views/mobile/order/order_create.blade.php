...
<div class="sub-container">
	...
	<div class="orderbox">
			...
			<form enctype="multipart/form-data" method="POST" action="{{ route('orders.store') }}" id="order_target">
				...
				<div class="orderall">
					<div class="leftform">
						<h3 class="yellow_tit"><i><img src="{{asset('/storage/image/mobile/img_yellowic.png')}}"></i> 주문자 정보</h3>
						...
						<div class="boxline">
							...
							<div class="otxt pt10">
								...
								<dl>
									...
									<dd>
										<input type="text" id="post_num" name="post_num" tabindex="2" title="우편번호" class="required kr" placeholder="우편번호" value="{{ old('post_num') }}" style="width:40%;"  onclick="Postcode()" readonly="readonly" required="required" /><a href="javascript:void(0)" onclick="Postcode();return false;" class="add_search">주소검색</a>
										...
										<dd class="w100">
											 <div  class="receipt_list bilkind_wrap">
													...
													<div class="tab1_content">
														<ul>
															<li class="w100">
																<div class="individual_kind_wrap" style="width:100%;display: inline-block;">
																...
																<div class="mobile_number_wrap" style="width:100%;display: inline-block;">
																	<input type="text" name="bilmobile_number" class="required kr" placeholder="핸드폰번호7자리" />
																</div>
																<div class="bilcard_number_wrap" style="width:100%;display: inline-block;display:none;">
																	<input type="text" name="bilcard_number" class="required kr" placeholder="현금영수증카드번호 12자리" />
																</div>
																<div class="business_bil" style="width:100%;display: inline-block;display:none;">
					...
					<div class="rightform">
						<h3 class="yellow_tit"><i><img src="{{asset('/storage/image/mobile/img_yellowic.png')}}"></i> 주문내역</h3>
						<div class="boxline graybox">
							<div class="pro_order">
								<ul>
									<li><img src="{{asset('storage/image/'.$product->artist_img)}}" alt="{{$product->title}}"></li>
									<li><span class="tit">{{$product->title}}</span><span class="option">작가명 : {{$product->artist_name}} <br/>사이즈 : {{$product->art_width_size}} X {{$product->art_height_size}}cm</span></li>
								</ul>
								<dl>
									<dt>상품금액   :    </dt>
									<dd>
							...
							<div class="check" >
								...
								<label for="check1"><span></span> 주문하실 상품 및 결제, 주문정보 확인하였으며, 이에 동의합니다. <strong>(필수)</strong></label>
							</div>
