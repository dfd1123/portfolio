...
function refresh_market_orderbook(data) {
    ...
    var nextSellOrders = data
        .sell_list.map(function(nextOrder) {
            ...
            return '<tr class="' + change + '" data-price="' + nextOrder.price.replace(',','') + '" data-amt="' + nextOrder.amt.replace(',','') + '">' + 
            '<td class="blue"><div class="per_bar" style="width: ' +  Number(nextOrder.amount_percent) * 600 + '%;"></div><span class="orderbook_price">' + nextOrder.price + '</span></td>' +
    ...
    var nextBuyOrders = data
        .buy_list.map(function(nextOrder) {
            ...
            return '<tr class="' + change + '"  data-price="' + nextOrder.price.replace(/\,/g,'') + '" data-amt="' + nextOrder.amt.replace(/\,/g,'') + '">' + 
            '<td class="red"><span class="orderbook_price">' + nextOrder.price + '</span></td>' +
            '<td><span class="orderbook_amt">' + nextOrder.amt + '</span><div class="per_bar" style="width: ' + Number(nextOrder.amount_percent) * 600 + '%;"></div></td>'+
