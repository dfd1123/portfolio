...
$('#newsplash_wrap').scroll(function(){
    if($('#newsplash_wrap').scrollTop() == $('#newsplash_tbl').height()-$('#newsplash_wrap').height()){
        more_newsplash();
    }
});

function more_newsplash(){
    var offset = $('#newsplash_tbl').data('offset');
    var count = $('#newsplash_tbl').data('count');
    ...
    if(offset < count){
        $.ajax({
            ...
            $('#newsplash_tbl').data('offset',data.offset);
            $('#newsplash_tbl tbody').append(data.str);

            if(data.offset >= count){
                $('#newsplash_wrap').attr('id','');
            }
        }).fail(function(){
            console.log("error");
        });
