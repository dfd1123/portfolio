...
function mypage_popup_open(name){
    $(name).addClass('popup_open');
}

function mypage_popup_close(){
    $('.popup_page').removeClass('popup_open');
    var templete = $($('#account_in_popup_content').html());
    $('#popup_page_account').html(templete);
}
