...
<div class="card mb-3 tsa-card">
	...
	<div class="card-body">
		<form enctype="multipart/form-data" class="event_edit_adm_form" id="event_add_form" method="post" action="{{route('admin.airdrop_store')}}">
			@csrf
				...
				<table class="table table-bordered cate_adm_table" width="100%" cellspacing="0">
					<tbody>
						<tr>
							...
							<td>
								<input type="text" name="title" class="form-control tsa-input-st" value=""/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<select name="cases">
									<option value="everybody">{{__('airdrop.who')}}</option>
									<option value="register">{{__('airdrop.join')}}</option>
									<option value="security_otp">{{__('airdrop.otp')}}</option>
									<option value="transaction">{{__('airdrop.first')}}</option>
								</select>
							</td>
						</tr>
						<tr>
							...
							<td>
								<select name="overlap_yn">
									<option value="0">{{__('airdrop.once')}}</option>
									<option value="1">{{__('airdrop.jook')}}</option>
								</select>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input type="number" name="send_cnt" class="form-control tsa-input-st" required="required" value=""/>
							</td>
						</tr>
						<tr>
							<th style="width:10%;">{{__('airdrop.all')}}</th>
							<td>
								<input type="number" name="all_cnt" class="form-control tsa-input-st" required="required" value=""/>
							</td>
						</tr>
						<tr>
							<th style="width:10%;">{{__('airdrop.date')}}</th>
							<td>
