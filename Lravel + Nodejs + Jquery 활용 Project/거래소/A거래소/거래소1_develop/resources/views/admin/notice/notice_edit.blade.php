...
<div class="card mb-3 tsa-card">
	...
	<div class="card-body">
		<form method="post" action="{{route('admin.notice_update',$id)}}" id="notice_form">
			@csrf
				...
				<table class="table table-bordered cate_adm_table" width="100%" cellspacing="0">
					<tbody>
						...
						<tr>
							...
							<td>
								<textarea name="description" id="editor">{!! $notice->description !!}</textarea>
							</td>
						</tr>
					</tbody>
				</table>
			...
			<div class="mint_btn_group">
                ...
                <button type="button" onclick="location.href='{{route('admin.notice_delete',['country' => $country, 'id' => $id])}}'">
				{{ __('notice.del')}}
                </button>
