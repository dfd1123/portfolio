...
<div class="card mb-3 tsa-card">
	...
	<div class="card-body">
		<form method="post" action="{{route('admin.qna_answer_update',$qna->id)}}" id="qna_form">
			@csrf
				...
				<table class="table table-bordered cate_adm_table" width="100%" cellspacing="0">
					<tbody>
						...
						<tr>
							...
							<td>
								{{$qna->createdby}} 
									<a href="{{route('admin.user_list')}}?keyword_srch=email&keyword={{$qna->createdby}}" target="_blank">상세정보보기</a>
							</td>
						</tr>
						@if($user !== NULL)
						<tr>
            ...
            <div>
                ...
                <textarea name="description" id="editor">{!! $qna_answer->description !!}</textarea>
            </div>
