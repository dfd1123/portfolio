        ...
        <div class="event_infor_panel">
            <div class="event_bar">
                <div class="event_bar_mask">
                    <ul class="event_ul">
                        @foreach($event_info->winning_Array as $winning)
                        <li>
                            {{$winning}}
                        </li>
                        @endforeach
            ...
            <div id="coin_buy_con" class="deal_con coin_buy_con">
                ...
                <div class="buysell_btn buy_btn">
                    @auth
                        ...
                        <a class="not_active_btn btn_style" onclick="alert('비정상적인 활동으로 이용이 정지되셨습니다.\n관리자에게 문의하세요.')">거래정지</a>
                        @else
        ...
        <div class="bottom_wrap">
            ...
            <div class="con_1 con_box">
                <div class="scrl_wrap">
                    ...
                    <!-- 코인리스트박스 -->
                    @foreach($coins as $coin)
                    <div class="my_coin_list_con exist_balance" data-symbol="{{ $coin->symbol }}" data-kind="public" style="{{ $result[$coin->api]['balance'] == 0 ? 'display:none' : '' }}">

                        <div class="hd dp_table ">

                            <div class="dp_table_cell _left added_arrow" onclick="location.href='/market_krw/{{ $coin->api }}';">
                                <img src="/images/coin_img/{{ strtolower($coin->image) }}" alt="coin_img" class="coin_symbol">
...
<!--N번째 이벤트 모달-->	
<div id="n_event_modal_m" class="modal">
    <div class="modal-content" id="n_event_modal_content_m">
    <span class="close" id="n_event_modal_close_m">x</span>
        <div class="modal-body">
            <img id="modalImg_m" src="/images/event/modal_event_congratulation_m.png"/>
            <p style="line-height:120%">
            <div id="n_event_modal_notify_m">{{ $event_info->number }}번째 이벤트에 당첨 되셨습니다.</div>
            <div id="n_event_modal_prize_m">상품: {{ $event_info->productName }}</div>
            <Button type="button" id="prize_Info_submmit_m" onclick="location.href='https://forms.gle/1m37PefZAjcRsPpFA'" ><p id="inner_prize_Info_submmit_m">당첨&nbsp;&nbsp;접수&nbsp;&nbsp;하러&nbsp;&nbsp;가기</p></Button>
            </p>
        </div>
    </div>
</div>
...
<script>
    document.getElementById("n_event_modal_close_m").onclick = function() { 
        $('#n_event_modal_m').css('display', 'none');
	};
