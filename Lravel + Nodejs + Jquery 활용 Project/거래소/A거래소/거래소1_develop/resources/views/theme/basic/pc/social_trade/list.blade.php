...
<div id="social_wrapper">
    ...
    <div class="hd_container">
        <div class="tit_group">
            ...
            <button type="button" class="_guide-btn" onClick="social_popup('social_popup-01')">{{ __('support.risk_step_guide') }}</button>
        </div>
    </div>
        ...
        <div class="popular_card_wrapper">
            <ul class="popular_card_group">
                <li class="popular_card_list">
                    <img src="/images/example/card_popular_01.png" alt="good popular card" onClick="social_popup('social_popup-02')">
                </li>
                <li class="popular_card_list">
                    <img src="/images/example/card_popular_02.png" alt="good popular card" onClick="social_popup('social_popup-02')">
                </li>
                <li class="popular_card_list">
                    <img src="/images/example/card_popular_03.png" alt="good popular card" onClick="social_popup('social_popup-02')">
                </li>
                <li class="popular_card_list">
                    <img src="/images/example/card_popular_04.png" alt="good popular card" onClick="social_popup('social_popup-02')">
                </li>
                <li class="popular_card_list">
                    <img src="/images/example/card_popular_05.png" alt="good popular card" onClick="social_popup('social_popup-02')">
                </li>
                <li class="popular_card_list">
                    <img src="/images/example/card_popular_06.png" alt="good popular card" onClick="social_popup('social_popup-02')">
                </li>
                <li class="popular_card_list">
                    <img src="/images/example/card_popular_07.png" alt="good popular card" onClick="social_popup('social_popup-02')">
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="social_popup social_popup-01">
        <img src="/images/example/ex_popup_01.png" alt="social popup image">
        <button type="button" class="_x-btn" onClick="social_popup_close()"></button>
    </div>

    <div class="social_popup social_popup-02">
        <img src="/images/example/ex_popup_02.png" alt="social popup image">
        <button type="button" class="_x-btn" onClick="social_popup_close()"></button>
    </div>
