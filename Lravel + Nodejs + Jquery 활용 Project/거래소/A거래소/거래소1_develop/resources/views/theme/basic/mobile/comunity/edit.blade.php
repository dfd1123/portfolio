            ...
            <div class="cs_table_view ios-scroll comunity_table_view">
                <div class="date_input_divs">
                    ...
                    <div class="date_input_list">
                        ...
                        <span class="_subjt">
                            <input type="text" name="title" class="_subjt_input" value="{{$board->title}}" placeholder="{{ __('support.please_input_title') }}" required="required">
                        </span>
                    </div>
                    ...
                    <div class="date_input_list">
                        ...
                        <span class="_subjt">
                            <label class="check_secret_label">
                                <input type="checkbox" class="checkbox_style hide" id="check_secret" {{($board->secret_key != NULL)?'checked=checked':''}}>
                ...
                <div class="comunity_board_write_container" style="padding:0 0;border:none;">
                    <!-- TODO: 글작성할 수 있는 공간 -->
                    <textarea name="content" id="textarea" style="width:100%;border:none;resize:none; padding:10px;">{!! $board->content !!}</textarea>
                </div>
                ...
                <div class="date_input_divs mt-4">
                    ...
                    <div class="date_input_list" style="display:none;">
                        <span class="_subjt filebox bs3-primary preview-image">
                            <input class="upload-name" value="{{($file1 == '')?'첨부파일 1':$file1}}" disabled="disabled" style="width: 80%">
                    ...
                    <div class="date_input_list" style="display:none;">
                        <span class="_subjt filebox bs3-primary preview-image">
                            <input class="upload-name" value="{{($file2 == '')?'첨부파일 2':$file2}}" disabled="disabled" style="width: 80%">
