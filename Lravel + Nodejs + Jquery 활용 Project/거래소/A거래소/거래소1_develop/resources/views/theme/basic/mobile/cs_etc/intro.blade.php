    ...
    <div class="scrl_wrap">
        ...
        <div class="com_intro_wrapper">
            ...
            <div class="intro_section">
                ...
                <p class="_text">{!! __('support.company_intro_sec01_txt_mobile') !!}</p>
            ...
            <div class="intro_desc_section">
                ...
                <div class="guide_line_text_wrapper">
                    ...
                    <div class="guide_line_text_con">
                        ...
                        <p class="mg_bt_0">{{ __('support.guide_line_02_txt01') }}</p>
                ...
                <div class="ex-roadmap-desc-wrapper">
                    <ul class="ex-roadmap-desc-group">
                        ...
                        <li class="ex-roadmap-desc-list">
                            ...
                            <h5 class="_tit">Major League Baseball<br>Fan club coin 상장</h5>
