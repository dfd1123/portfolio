        ...
        <div class="password_box">
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="reg_inp">
                    ...
                    <div>
                        <input type="email" name="email" id="email" class="" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus />
                    </div>
                </div>
                ...
                <button type="submit" class="bg_wh_btn">비밀번호 변경</button>
            </form>
        </div>
    </div>
</div>
