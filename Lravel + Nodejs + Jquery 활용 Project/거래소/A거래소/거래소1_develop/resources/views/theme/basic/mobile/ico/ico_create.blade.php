            ...
            <div class="right_con">
                <form method="post" action="{{route('ico_insert')}}" enctype="multipart/form-data" name="allform" id="create_form">
                    ...
                    <section class="info_form_group _notice">
                        ...
                        <h5>{{ __('icoo.ico_post_info')}}</h5>

                        <p class="form_align">
                            <label class="tit">{{ __('icoo.ico_title')}}</label>
                    ...
                    <section class="info_form_group">
                        ...
                        <div class="form_align">
                            <label class="tit">{{ __('icoo.vailable_coin')}}</label>
                            <div class="w_100">
                        ...
                        <div class="form_align _buyprice">
                            ...
                            <div class="w_100">
                                ...
                                <div class="grouper">
                                    <input type="number" id="ico_coin_p" name="ico_coin_p" class="form-control w_180px mr-2" placeholder="{{ __('icoo.inputprice')}}" >
                        ...
                        <div class="form_align">
                            <label class="tit">{{ __('icoo.minimum_goal')}}</label>
                            <div class="w_100">
                                <input name="ico_goal" type="number" class="form-control w_180px mr-2 float-left" placeholder="{{ __('icoo.inputmoney')}}"  />
                                <input type="text" class="form-control symbol_form bd-red red text-center float-left collect_symbol" readonly value="SYMBOL">
                            </div>
                        </div>
                    ...
                    <section class="info_form_group _detail">
                        ...
                        <div class="form_align_group mt-3 bb-f0f0">
                            <label class="tit under_txt pdf">{{ __('icoo.white_papaer')}}</label>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="ico_whitepater[]" placeholder="{{ __('icoo.filename')}}" id="white_pp_jp" class="hide pdf_up ico_file_inp">
                                        ...
                                        <td>
                                            <input type="file" name="ico_whitepater[]" placeholder="{{ __('icoo.filename')}}" id="white_pp_eng" class="hide pdf_up ico_file_inp">
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="ico_whitepater[]" placeholder="{{ __('icoo.filename')}}" id="white_pp_cn" class="hide pdf_up ico_file_inp">
                                        ...
                                        <td>
                                            <input type="file" name="ico_whitepater[]" placeholder="{{ __('icoo.filename')}}" id="white_pp_kr" class="hide pdf_up ico_file_inp">
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="ico_report[]" placeholder="{{ __('icoo.filename')}}" id="essay_rpt_jp" class="hide pdf_up ico_file_inp">
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                                        ...
                                        <td>
                                            <input type="file" name="ico_report[]" placeholder="{{ __('icoo.filename')}}" id="essay_rpt_eng" class="hide pdf_up ico_file_inp">
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="ico_report[]" placeholder="{{ __('icoo.filename')}}" id="essay_rpt_cn" class="hide pdf_up ico_file_inp">
                                            <input type="text" value="" class="form-control mr-2 float-left mb-2 filename_input" placeholder="{{ __('icoo.filename')}}">
                                        ...
                                        <td>
                                            <input type="file" name="ico_report[]" placeholder="{{ __('icoo.filename')}}" id="essay_rpt_kr" class="hide pdf_up ico_file_inp">
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="cont[]" placeholder="{{ __('icoo.filename')}}" id="detail_page1" class="hide img_up ico_file_inp" >
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                                        ...
                                        <td>
                                            <input type="file" name="cont[]" placeholder="{{ __('icoo.filename')}}" id="detail_page2" class="hide img_up ico_file_inp" >
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="cont[]" placeholder="{{ __('icoo.filename')}}" id="detail_page3" class="hide img_up ico_file_inp" >
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
