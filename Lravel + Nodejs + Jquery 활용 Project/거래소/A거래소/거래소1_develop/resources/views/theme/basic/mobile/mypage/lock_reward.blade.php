...
<div class="m_mypage_wrap scrl_wrap m_mypage_wrap-3">
    ...
    <h2 class="title mb-5" style="text-align: center;">{{ __('myp.nolock') }}</h2>
    {{-- //없을때 --}} 
    @else
        ...
        <div class="lock_div">
            <form method="post" action="{{route('mypage.lock_reward_update', $coin)}}">
                ...
                <div class="coin_amount_bar">
                    ...
                    <input id="amount_coin" type="text" name="amount" placeholder="0.00000000" class="mr-2 point_b">
                ...
                <div class="both_btn_group">
                    ...
                    <button type="submit" id="btn_lock" name="operation" value="lock" class="btn_lock_back">
                        <i class="svgicon lock_icon"></i><span>{{ __('myp.lock') }}</span>
                    </button> @endif
                    <button type="submit" id="btn_unlock" name="operation" value="unlock" class="btn_unlock_back">
    ...
    <div class="lock_reward_group">
        ...
        <div class="lock_history_tab">
            <ul>
                <li class="active mr_space">{{ __('myp.lock_list') }}</li>
            ...
            <table id="lock_history" class="coin_chart_tbl">
                <tbody>
                    ...
                    <tr class="none_status">
                        <td colspan="3">
                        <img src="/images/icon_notice.svg" alt="icon_notice" class="lock_icon_notice">    
                         {{ __('myp.mypage_sentence4') }}</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
