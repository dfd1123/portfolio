...
<div id="p2p_history_wrap" class="scrl_wrap m_p2p_wrap m_p2p_wrap-3">
    ...
    <div class="sch_option_wrap">
        ...
        <div class="option_bar bb-dddd term_added_btn">
        ...
        <div class="option_group">
            ...
            <div class="inner_line">
                <button class="btn_style btn_style_dark" onclick="search_date_history();">{{ __('ptop.lookup') }}</button>
            </div>
        </div>
