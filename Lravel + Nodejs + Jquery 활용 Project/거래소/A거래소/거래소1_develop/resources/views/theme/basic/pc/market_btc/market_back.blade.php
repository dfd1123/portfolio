										...
										<tbody>
											...
											<tr>
												<td>
													<div class="fee_box">
														<span>수수료</span>
														<span><em>0</em><em>{{ $symbol_text }}</em></span>
													</div>
												</td>
											</tr>
											<tr>
												...
												<div class="buysell_btn buy_btn">
													@auth
														@if($security_lv < 2)
															@if($security_lv == 0)
																<a class="not_active_btn" href="{{route('verification.notice')}}">{{ __('market.login') }}</a>
															@else
									...
									<table class="trans_tbl">
										<thead class="tbl_head">
											<tr>
												...
												<th>{{ __('market.order_price') }}</th>
												<th>{{ __('market.order_quantity') }}</th>
												<th>{{ __('market.conclusion_quantity') }}</th>
												<th>{{ __('market.not_conclusion_quantity') }}</th>
												<th>{{ __('market.now') }}</th>
											</tr>
										</thead>
									</table>
