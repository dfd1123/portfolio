...
return [
    ...
    'please_change_another_coin' => 'Currently, USDC is a coin that can not be deposited or withdrawn..',
    ...
    'not_wait_trade_list' => 'No closing history exists.',
    //market
    ...
    'is_coin_in' => 'Did you receive cash?',
    ...
    //0329_transwallet
    'rusure' => 'Are you sure you want to convert bitcoins to USDC?',
    ...
    'join_certification' => 'Please check the e-mail sent to registered e-mails and press the authentication button.',
		...
		'cash_deposite_success' => 'You requested a deposit. The account you deposit must be deposited into the account you have verified and the deposit request will be accepted after confirming the deposit.',
		'cash_deposite_error1' => 'You already have a deposit or withdrawal history.',
		'cash_deposite_error2' => 'Deposit failed',

		'cash_withdraw_success' => 'You requested a withdrawal request. It will be withdrawn after manager approval.',
		'cash_withdraw_error1' => 'You have entered a withdrawal amount greater than or equal to $ 0.',
		'cash_withdraw_error2' => 'You can not withdraw an amount greater than the one-day withdrawal limit.',
		'cash_withdraw_error3' => 'Failure to withdraw',

		'cash_cancel_success' => 'You have canceled this request.',
		'cash_cancel_error' => 'Cancellation failed',

		'deposite_request' => 'Cancellation failed',
		'deposite_reject' => 'Refused deposit',
		'deposite_cancel' => 'Cancel deposit',
		'withdraw_request' => 'Requesting withdrawal',
		'withdraw_reject' => 'Refused withdrawal',
		'withdraw_cancel' => 'Withdrawal withdrawal',
