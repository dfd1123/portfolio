		...
		<div class="trans_con">
				...
				<div id="top_ticker" class="trans_hd" data-coin="{{$trade_coin->api}}">
					...
					<div class="coin_state_1">
						...
						<p class="coin_name in_cell">
							...
							<span class="c_name_eng">{{$trade_coin->symbol}}/UCSS</span>
						</p>

						<p class="coin_num_data in_cell">
							<span class="{{$up_down_color}}"> <b class="last_trade_price">{{number_format($trade_coin->last_trade_price_usd, $trade_coin->decimal_usd)}}</b> UCSS <u class="price_change_24h">({{$price_change_24h_number_symbol}}{{number_format($trade_coin->price_change_24h, $trade_coin->decimal_usd)}})</u> </span>
					...
					<div class="coin_state_2">
						<ul>
							<li class="border_r border_b">
								...
								<span class="high_price_24h align_right"> <b class="number_price">{{number_format($trade_coin->max_price, $trade_coin->decimal_usd)}}</b> <u>UCSS</u> </span>
							...
							<li class="border_b">
								...
								<span class="trade_volume_24h align_right"> <b class="number_price">{{number_format($trade_coin->{'24h_volume'},8)}}</b> <u>UCSS</u> </span>
							...
							<li class="border_r">
								...
								<span class="row_price_24h align_right"> <b class="number_price">{{number_format($trade_coin->min_price, $trade_coin->decimal_usd)}}</b> <u>UCSS</u> </span>
				...
				<div class="trans_chart_wrap">
					...
					<div class="deal_wrap">
						...
						<div id="coin_buy_con" class="deal_con coin_buy_con">
							...
							{{ __('market.ucss_balance') }} :
								<u>{{number_format($user_current_cash_balance,$trade_coin->decimal_usd)}}</u> UCSS
							</div>
			...
			<div class="right_con">
				<div class="inner_box right_con_inbox-1">
					...
					<div class="scl_wrap">
						<input id="ucss_market_list" class="hide" type="radio" name="coin_list" />
							...
							@forelse($today_historys as $today_history)
								@if($today_history->buyer_username == $username)
									<tr>
										...
										<td><span>{{number_format($today_history->trade_usd_amt_buy, $trade_coin->decimal_usd)}} UCSS</span></td>
									</tr>
								@else
									<tr>
										<td><span>{{date("m-d H:i:s", strtotime("+9 hours", strtotime($today_history->created_dt)))}}</span></td>
										...
										<td><span>{{number_format($today_history->contract_coin_amt, 8)}} {{strtoupper($today_history->cointype)}}</span></td>
										<td><span>{{number_format($today_history->trade_usd_amt_sell, $trade_coin->decimal_usd)}} UCSS</span></td>
									</tr>
								@endif
							@empty
								<tr>
