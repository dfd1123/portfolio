...
<div class="coin_select_bar" id="coin_slt_bar">
    <label for="list_check">
        <p class="select_tit">
            ...
            <span class="currency">{{$trade_coin->symbol}} / UCSS</span>
        </p>
    </label>
        ...
        <ul class="select_list coin_list-1">
            ...
            <li>
                <a href="{{route('market',$coin->symbol)}}">
                    ...
                    {{__('coin_name.'.$coin->api)}}({{$coin->symbol}}/UCSS)
                </a>
            </li>
            @endforeach
        </ul>
    ...
    <div class="bottom_wrap trade_wrap">
        ...
        <div class="right_con">
            ...
            <div id="coin_buy_con" class="deal_con coin_buy_con">
                ...
                {{ __('market.ucss_balance') }} : <u>{{number_format($user_current_cash_balance,$trade_coin->decimal_usd)}} UCSS</u>
                </span>
