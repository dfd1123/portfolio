...
<head>
    ...
    <meta property="og:title" content="sharebits">
    <meta property="og:description" content="trademarket-SHAREBITS">
    ...
    <link rel="mask-icon" href="{{ asset('/storage/image/homepage/favicon/safari-pinned-tab.svg') }}" color="#4aa4a4">
    ...
    @if($pagename[1] == 'market')
			<script type="text/javascript" src="{{ asset('vendor/tradingview_new/charting_library/charting_library.min.js') }}"></script>
			<script type="text/javascript" src="{{ asset('vendor/tradingview_new/datafeeds/udf/dist/polyfills.js') }}"></script>
			<script type="text/javascript" src="{{ asset('vendor/tradingview_new/datafeeds/udf/dist/bundle.js') }}"></script>
