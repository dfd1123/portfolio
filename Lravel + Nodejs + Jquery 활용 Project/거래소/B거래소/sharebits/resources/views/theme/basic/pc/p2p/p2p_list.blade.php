				...
				<div class="tab_menu_bar">
					...
					@auth
						@if(Auth::user()->status != 2)
							<a href="#" id="p2pWrite" class="write_btn_st write_btn p2pWrite"><i class="fal fa-plus"></i> {{ __('ptop.entollment_out_trade') }}</a>
						@endif
					@endauth
				</div>
					...
					<div class="p2p_sch_bar mb-3">
						<div class="form-group">
							...
							@csrf
								...
								<input placeholder="{{ __('ptop.writersearch') }}" type="text" id="p2p_list_srch" class="form-control" name="srch">
								<button type="submit" class="btn_style ml-1">{{ __('ptop.search') }}</button>
							</form>
						</div>
					</div>
