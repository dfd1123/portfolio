    ...
    <div class="card-body">
        <ul class="nav nav-tabs">
            @if($types == 0)
                ...
                <li><a href="{{route('admin.p2p_list',2)}}">{{ __('admin_p2p.ok2')}}</a></li>
                <li><a href="{{route('admin.p2p_list',3)}}">{{ __('admin_p2p.ok3')}}</a></li>
            ...
            @elseif($types == 2)
                <li><a href="{{route('admin.p2p_list',0)}}">{{ __('admin_p2p.exchage')}}</a></li>
                <li><a href="{{route('admin.p2p_list',1)}}">{{ __('admin_p2p.ok1')}}</a></li>
                <li class="active"><a href="{{route('admin.p2p_list',2)}}">{{ __('admin_p2p.ok2')}}</a></li>
                <li><a href="{{route('admin.p2p_list',3)}}">{{ __('admin_p2p.ok3')}}</a></li>
                <li><a href="{{route('admin.p2p_list',4)}}">{{ __('admin_p2p.deal1')}}</a></li>
                <li><a href="{{route('admin.p2p_list',5)}}">{{ __('admin_p2p.deal2')}}</a></li>
                <li><a href="{{route('admin.p2p_list',6)}}">{{ __('admin_p2p.deal3')}}</a></li>
            @elseif($types == 3)
                ...
                <li><a href="{{route('admin.p2p_list',1)}}">{{ __('admin_p2p.ok1')}}</a></li>
                <li><a href="{{route('admin.p2p_list',2)}}">{{ __('admin_p2p.ok2')}}</a></li>
                <li class="active"><a href="{{route('admin.p2p_list',3)}}">{{ __('admin_p2p.ok3')}}</a></li>
                <li><a href="{{route('admin.p2p_list',4)}}">{{ __('admin_p2p.deal1')}}</a></li>
                <li><a href="{{route('admin.p2p_list',5)}}">{{ __('admin_p2p.deal2')}}</a></li>
                <li><a href="{{route('admin.p2p_list',6)}}">{{ __('admin_p2p.deal3')}}</a></li>
            @elseif($types == 4)
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if($p2p->confirm > 0 && $p2p->confirm < 4 && $p2p->deleted != 1 && $p2p->state != 'stop')
                            <button class="myButton navy" onclick="location.href='{{route('admin.p2p_confirm',$p2p->id)}}'">{{ __('admin_p2p.app')}}</button>
