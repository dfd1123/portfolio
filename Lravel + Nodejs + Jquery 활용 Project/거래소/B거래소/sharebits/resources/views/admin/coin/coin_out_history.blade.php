		...
		<div class="usr_search_box tsa-sch-box">
			<form method="get" action="">
					<select name="category">
                        ...
                        <option value="cointype">{{ __('coin.symbol')}}</option>
						<option value="sender_userid">{{ __('coin.user')}}</option>
                        <option value="receiver_address">{{ __('coin.adrs')}}</option>
					</select>
			...
			<table class="table table-bordered" width="100%" cellspacing="0">
				...
				<tbody>
					...
					<tr>
                        ...
                        <td rowspan="1">{{$co_history->sender_userid}}</td>
                        <td rowspan="2">{{strtoupper($co_history->cointype)}}</td>
