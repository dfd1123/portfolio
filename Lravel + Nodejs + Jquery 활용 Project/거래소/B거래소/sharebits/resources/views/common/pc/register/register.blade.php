                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="mobile_number" class="col-md-4 col-form-label text-md-right">휴대폰번호</label>
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right">지갑계정</label>
                        ...
                        <div class="form-group row" style="display:none;">
                            <label for="referral_id" class="col-md-4 col-form-label text-md-right">지갑계정</label>
...
<div>
	<button type="button" class="test_btn">테스트</button>
</div>
