                ...
                <div class="card-body">
					...
					<form method="get" action="{{route('register')}}" id="register_agree">
						<div class="in_register_wrapper">
							<div class="agree_con">
								<div class="top_tit">
									<label for="register_agree1">Sharebits 거래소 서비스 이용약관 동의 (필수)</label><input class="grayCheckbox" type="checkbox" id="register_agree1" name="register_agree1" value="0" />
								</div>
							...
							<div class="agree_con">
								<div class="top_tit">
									<label for="register_agree2">Sharebits 거래소 개인정보 수집 및 이용동의 (필수)</label><input class="grayCheckbox" type="checkbox"  id="register_agree2" name="register_agree2" value="0" />
								</div>
							...
							<div class="top_tit last_top_tit">
								<label for="register_agree3">Sharebits 거래소 마케팅 수신에 동의합니다. (선택)</label><input class="grayCheckbox" type="checkbox" id="register_agree3" name="register_agree3" value="0" />
							</div>
