                    ...
                    if($airdrop->overlap_yn == 0){
                        ...
                        if($getter_cnt == 0){
                            ...
                            DB::table('btc_transaction')->insert([
                                "cointxid" => $airdrop->coin.'_airdrop_transfer_'.$airdrop->send_cnt.'_shareBits to '.$user->username,
                                "cointype" => $airdrop->coin,
                                "account" => "shareBits",
                                ...
                                "confirmations" => 999,
                                "txid" => $airdrop->coin.'_airdrop_transfer_'.$airdrop->send_cnt.'_shareBits to '.$user->username,
                                "normtxid" => '',
                                "tr_time" => time(),
                                "timereceived" => time(),
                                "processed" => 'y',
