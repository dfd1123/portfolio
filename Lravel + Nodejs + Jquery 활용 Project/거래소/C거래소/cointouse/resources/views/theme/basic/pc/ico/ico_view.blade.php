        ...
        <div class="board_st_con ico_view_con">
            ...
            <div class="main_info">
                ...
                <section class="infos">
                    ...
                    {{ __('icoo.writer')}} <span class="idbywriten pl-2 pr-3 mr-3">{{$ico->w_name}}</span> {{ __('icoo.write_date')}} <span class="datewriten">{{$ico->created_at}}</span>
                    </p>
                    ...
                    @auth
                        ...
                        @else
                            <button type="button" class="btn_style mt-4  @if($ico->ico_category != 1 || $ico->active != 1) not_active_btn @endif" onclick="func_buy()">{{ __('icoo.buy')}}</button> 
                        @endif
                    @else
