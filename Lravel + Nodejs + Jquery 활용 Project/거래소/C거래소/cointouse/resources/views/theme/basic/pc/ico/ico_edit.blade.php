...
<div class="board_st_wrap p2p_ico_wrap ico_create_wrap">
    ...
    @include(session('theme').'.pc.ico.include.sub_menu')
            ...
            <div class="right_con">
                <form method="post" action="{{route('ico_update')}}" enctype="multipart/form-data" name="allform" id="create_form">
                    ...
                    <section class="info_form_group _notice">
                        ...
                        <p class="form_align">
                            ...
                            <input type="text" id="tp_tit" name="title" class="form-control" placeholder="{{ __('icoo.m_input_title')}}" required>
                        ...
                        <div class="form_align">
                            ...
                            <div class="w_100">
                                <input type="file" name="thumnail" placeholder="{{ __('icoo.filename')}}" id="thum_file" class="hide img_up" required>
                    ...
                    <section class="info_form_group">
                        ...
                        <p class="form_align">
                            ...
                            <input type="text" name="coin_name" class="form-control" placeholder="{{ __('icoo.input_coinname')}}" required>
                        </p>

                        <div class="form_align">
                            <label class="tit">{{ __('icoo.ico_symbol')}}</label>
                            <div class="w_100">
                                <input type="text" id="coin_symbol" name="symbol" class="form-control bd-blue w_half" placeholder="{{ __('icoo.input_sym')}}  (ex: BTC, ETH)" required>
                            </div>
                        </div>
                        ...
                        <div class="form_align">
                            ...
                            <div class="w_100">
                                <select id="collect_coin"name="collect" class="form-control bd-red w_half" required>
                        ...
                        <div class="form_align _buyprice">
                            ...
                            <div class="w_100">
                                ...
                                <div class="grouper">
                                    <input type="number" id="ico_coin_p" name="ico_coin_p" class="form-control w_180px mr-2" placeholder="{{ __('icoo.inputprice')}}" required>
                        ...
                        <div class="form_align">
                            ...
                            <div class="w_100">
                                <input name="ico_min" type="number" class="form-control w_180px mr-2 float-left" placeholder="{{ __('icoo.inputmoney')}}" required />
                        ...
                        <div class="form_align">
                            ...
                            <div class="w_100">
                                <input name="ico_goal" type="number" class="form-control w_180px mr-2 float-left" placeholder="{{ __('icoo.inputmoney')}}" required />
                                <input type="text" class="form-control symbol_form bd-red red text-center float-left collect_symbol" readonly value="SYMBOL">
                            </div>
                        </div>
                        ...
                        <div class="form_align">
                            ...
                            <div class="w_100">
                                <input type="text" name="ico_from" id="start_sch_ico" class="form-control w_180px float-left mr-2" placeholder="{{ __('icoo.select_date')}}" required>
                                <input type="text" name="ico_from_h" class="form-control w_180px start_timepicker" required>
                            </div>
                        </div>
                        ...
                        <div class="form_align">
                            ...
                            <div class="w_100">
                                <input type="text" name="ico_to" id="end_sch_ico" class="form-control w_180px float-left mr-2" placeholder="{{ __('icoo.select_date')}}" required>
                                <input type="text" name="ico_to_h" class="form-control w_180px end_timepicker" required>
                            </div>
                        </div>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="ico_whitepater[]" placeholder="{{ __('icoo.filename')}}" id="white_pp_jp" class="hide pdf_up">
                                        ...
                                        <td>
                                            <input type="file" name="ico_whitepater[]" placeholder="{{ __('icoo.filename')}}" id="white_pp_eng" class="hide pdf_up">
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="ico_whitepater[]" placeholder="{{ __('icoo.filename')}}" id="white_pp_cn" class="hide pdf_up">
                                        ...
                                        <td>
                                            <input type="file" name="ico_whitepater[]" placeholder="{{ __('icoo.filename')}}" id="white_pp_kr" class="hide pdf_up">
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="ico_report[]" placeholder="{{ __('icoo.filename')}}" id="essay_rpt_jp" class="hide pdf_up">
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                                        ...
                                        <td>
                                            <input type="file" name="ico_report[]" placeholder="{{ __('icoo.filename')}}" id="essay_rpt_eng" class="hide pdf_up">
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="ico_report[]" placeholder="{{ __('icoo.filename')}}" id="essay_rpt_cn" class="hide pdf_up">
                                            <input type="text" value="" class="form-control mr-2 float-left mb-2 filename_input" placeholder="{{ __('icoo.filename')}}">
                                        ...
                                        <td>
                                            <input type="file" name="ico_report[]" placeholder="{{ __('icoo.filename')}}" id="essay_rpt_kr" class="hide pdf_up">
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="sns_url[]" value="" class="form-control mr-2 float-left" placeholder="기타 SNS {{ __('icoo.adrs')}}">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="cont[]" placeholder="{{ __('icoo.filename')}}" id="detail_page1" class="hide img_up" required>
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                                        ...
                                        <td>
                                            <input type="file" name="cont[]" placeholder="{{ __('icoo.filename')}}" id="detail_page2" class="hide img_up" required>
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="cont[]" placeholder="{{ __('icoo.filename')}}" id="detail_page3" class="hide img_up" required>
                                            <input type="text" value="" class="form-control mr-2 float-left filename_input" placeholder="{{ __('icoo.filename')}}">
