...
<div class="main_table_wrap">
    ...
    <div class="width_align">
        ...
        <div class="main_chart_top_tab">
            <ul>
                <li class="active">
                    <label for="krwmarket_check">
                        KRW {{__('main.market')}}
                    </label>
                </li>
                <li >
                    <label for="usdcmarket_check">
                        USDC {{__('main.market')}}
                    </label>
                </li>
                {{--
        ...
        <input id="krwmarket_check" class="hide" type="radio" name="market_check" />
        <input id="usdcmarket_check" class="hide" type="radio" name="market_check" />
        ...
        {{-- KRW마켓 코인테이블 --}}
        <table id="coin_table_krw" class="coin_chart_tbl main_chart_1">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                @if($coin->api != 'krw')
                    ...
                    <tr id="row_{{$coin->api}}" onclick="window.location.href = '{{route('marketKRW', $coin->api)}}';">
                        <td class="coin_td"><img src="{{ asset('/storage/image/homepage/coin_img/'.strtolower($coin->image))}}" alt="{{__('coin_name.'.$coin->api)}}" class="coin_symbol"/><span class="coin_name">{{__('coin_name.'.$coin->api)}}</span><span class="coin_name_eng">{{$coin->symbol}}/KRW</span></td>
        ...
        {{-- USDC마켓 코인테이블 --}}
        <table id="coin_table_usd" class="coin_chart_tbl main_chart_4">
            <thead>
                <tr>
                    <th>USDC {{__('main.market')}} {{ __('main.coin') }}</th>
                    <th>{{__('main.yesterday')}}</th>
                    <th>{{__('main.price')}}</th>
            ...
            <tbody>
                @forelse($coins as $coin)
	                ...
	                <tr id="row_{{$coin->api}}" onclick="window.location.href = '{{route('marketUSDC', $coin->api)}}';">
	                    <td class="coin_td"><img src="{{ asset('/storage/image/homepage/coin_img/'.strtolower($coin->image))}}" alt="{{__('coin_name.'.$coin->api)}}" class="coin_symbol"/><span class="coin_name">{{__('coin_name.'.$coin->api)}}</span><span class="coin_name_eng">{{$coin->symbol}}/USDC</span></td>
...
<!--③about cointouse_1 start-->
<div class="main_section_wrap_1">
    <div class="width_align">
        <div class="mockup_img_wrap"> 
            <img src="{{ asset('/images/allcoinwallet_mockup_01.png')}}" alt="allcoinwallet_mockup_01" class="allcoinwallet_mockup_01"/>
            <img src="{{ asset('/images/allcoinwallet_mockup_02.png')}}" alt="allcoinwallet_mockup_02" class="allcoinwallet_mockup_02"/>
        </div>
        <div class="text_box">
            {!! __('main.main_sentence6') !!}
            
            <div class="acw_download_btn">
                <button type="button" onclick="window.open('http://aicdss.com/bbs/about_wlt.php')" >VISIT SITE</button>
                <button type="button"><img src="{{ asset('/images/button_google_wh.svg')}}" alt="allcoinwallet_googleplay"></button>
                <button type="button"><img src="{{ asset('/images/button_apple_white.svg')}}" alt="allcoinwallet_appstore"></button>
            </div>
            <p>
...
<!--③about cointouse_1 end-->

<!--④about cointouse_2 start-->
...
@auth
    <a href="{{ route('marketKRW','btc') }}" class="direct_btn mt-4">{{__('main.go_trademarket')}}</a></button>
@else
