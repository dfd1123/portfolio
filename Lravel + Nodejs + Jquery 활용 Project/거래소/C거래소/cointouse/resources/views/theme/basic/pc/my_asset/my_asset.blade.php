							...
							<ul>
								...
								@foreach($coins as $coin)
									...
									<tr name="{{ __('coin_name.'.$coin->api) }}">
										<td class="coin_td"><img class="coin_symbol" src="{{ asset('/storage/image/homepage/coin_img/'.$coin->api.'.png')}}" alt="coin_img"><span class="coin_name">{{ __('coin_name.'.$coin->api) }}</span><span class="coin_name_eng">{{ $coin->api }}/KRW</span></td>
										<td>
											<p>
