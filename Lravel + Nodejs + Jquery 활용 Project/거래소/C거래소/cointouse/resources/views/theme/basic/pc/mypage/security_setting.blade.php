...
<div class="mypage_wrap">
    ...
    <div class="mypage_inner">
        ...
        <div class="lv_certifi_before">
            ...
            @elseif($status == 2)
            <p class="big_tit notosans mb-3">{{ __('boan.document_submit_boan')}}</p>
            <h2 class="title mb-5">{!! __('boan.phone_ok_next_document') !!}</h2>
            @elseif($status == 3)
            <p class="big_tit notosans mb-3">{{ __('boan.account_submit_boan')}}</p>
            <h2 class="title mb-5">{!! __('boan.document_ok_next_account') !!}</h2>
            @elseif($status == 3.5)
            <p class="big_tit notosans mb-3">{{ __('boan.complete_submit_boan')}}</p>
            <h2 class="title mb-5">{!! __('boan.account_ok_next_otp') !!}</h2>
            @endif
                ...
                @elseif($status == 2.5)
                	...
                	<div class="lv2_certifi_form_wrap">
                        ...
                        @csrf
	                        ...
	                        <div class="form-group mb-2">
	                            <div class="certifi_form_group">
	                                <input type="text" name="account_num" id="account_num" class="mr-1 auth_input form-control" placeholder="{{__('boan.placeholder_account2')}}">
	                            </div>
	                        </div>
	                        
	                        <div class="form-group mb-2">
	                            <div class="certifi_form_group">
	                                <input type="text" name="account_bank" id="account_bank" class="mr-1 auth_input form-control" placeholder="{{__('boan.placeholder_account1')}}">
	                            </div>
	                        </div>
