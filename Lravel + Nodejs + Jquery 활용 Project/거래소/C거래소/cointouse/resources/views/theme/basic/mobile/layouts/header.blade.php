    ...
    <div class="scrl_wrap">
            ...
            <div class="my_total_asset dp_table">
                <div class="dp_table_cell">
                    ...
                    <!-- 회원일 경우 -->
                    <p class="ast_num point_clr_1">{{number_format($total_holding,8)}}<span class="ml-2 currency">USDC</span></p>
                    <!-- //회원일 경우 -->
                </div>
            </div>
            @else
                <!-- 비회원일 경우 -->
                {{-- <p class="ast_num">0.00<span class="ml-2 currency">USDC</span></p> --}}
                <!-- //비회원일 경우 -->
            @endauth
            ...
            <nav class="nav_group">
                <ul class="nav_ul">
                    ...
                    <li class="main_menu drop_menu">
                        <a href="#">
                            <label for="sub_menu4">
                                <i class="nav-menu-icon"></i>ICO/IEO
