...
CREATE TABLE `eth_io_account` (
  ...
  `address` varchar(255) NOT NULL COMMENT '주소(공개키)',
  `private` varchar(255) NOT NULL COMMENT '비밀번호(개인키)',
...
(1, 'test', '0x42488a0396033D62Ed0cbf36A5ea4A33d51409DF', '0x0700b5f49274bd0d768a34199744e8bd49a758207162226d6acd970f6c0316ad', '2019-04-23 05:17:15');
