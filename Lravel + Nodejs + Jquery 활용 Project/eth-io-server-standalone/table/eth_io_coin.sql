...
CREATE TABLE `eth_io_coin` (
  ...
  `coin_kind` varchar(255) NOT NULL COMMENT '코인 심볼(소문자)',
  `coin_type` varchar(64) NOT NULL DEFAULT 'token' COMMENT '코인 종류(coin, token)',
  `coin_decimals` int(11) NOT NULL DEFAULT '18' COMMENT '코인 소숫점 자리수',
...
(2, 'Test Standard Coin', 'tst', 'token', 18, '0x722dd3F80BAC40c951b51BdD28Dd19d435762180', '2019-05-08 06:55:28');
...
ALTER TABLE `eth_io_coin`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `coin_kind` (`coin_kind`);
