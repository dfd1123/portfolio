	...
	<div class="board_st_inner">
		...
		<div class="board_st_con">
			...
			<div class="right_con">
				...
				<h1 class="main_tit">{{ __('support.one_to_one_ask') }}</h1>
						...
						<div class="answer_box">
							...
							@else
								<p class="answer_p nothing_p">
									<i class="fas fa-exclamation-circle not_i"></i>
...
@if(!$qna_answer)
	...
	<div class="modal_popup hide" id="qnaModify1">
		...
		<form method="post" enctype="multipart/form-data" action="{{route('qna_insert')}}">
			...
			<div class="form-group mb-4" style="height: 35px;">
				...
				<input type="text" value="" class="form-control mr-2 float-left filename_input" style="width: 58%;" readonly>
				<label class="form-control attach_btn float-left" for="thum_file" style="width: 40%;">{{ __('support.add_image') }}</label>
			</div>
