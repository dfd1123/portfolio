...
<div class="coin_select_bar" id="coin_slt_bar">
    ...
    <div class="market_list_n_coin_list">
        <ul class="market_list_tab">
            <li {{($standard_info->api == 'ucss')?'class=active':''}}>
        ...
        <input id="ucss_market_list" class="hide" type="radio" name="coin_list" {{($standard_info->api == 'ucss')?'checked=checked':''}} />
        ...
        <ul class="select_list coin_list-1">
            ...
            <li>
                <a href="{{route('marketUCSS',$coin->symbol)}}">
