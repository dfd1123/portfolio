...
define("REMOTE_REPOSITORY", "git@github-exchange1-web:pocketcompany/exchange1-web.git");             // The SSH URL to your repository
define("DIR", "/var/www/exchange1/exchange1-web/");                                 // The path to your repostiroy; this must begin with a forward slash (/)
